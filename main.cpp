...
bool fightMonster(vector<Character*>&, Monster, int);
...
bool fightMonster(vector<Character*>& heroes, Monster m, int l)
{
	int ans;
	string keepGoing = "y";
	bool meDead = false;
...
//	Knight k1("ires");
//	Wizard w1("ewr");
//	std::cout << "Novice attack: " << n1.getAttack() << std::endl;
//	std::cout << "Knight attack: " << k1.getAttack() << std::endl;
//	std::cout << "Wizard attack: " << w1.getAttack() << std::endl;
//	//std::cout << w1.getAttack() << std::endl;
//	n1.print();
//	n1.updateHP(15);
//	n1.updateXP(15);
//	n1.print();
...
//	k1.updateXP(15);
//	k1.print();
////	std::cout << k1.getAttack() << std::endl;
//	w1.print();
//	w1.updateHP(15);
//	w1.updateXP(15);
//	w1.print();